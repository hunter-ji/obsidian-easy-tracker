...
const en = {
	...
	'card.todayTotal': 'Today\'s Total: {{total}}',
	'card.entryCount': '{{count}} entries',
	'modal.customValueTitle': 'Enter value',
	'modal.customValuePlaceholder': 'How much?',
	'modal.submit': 'Submit',
	'notice.invalidValue': 'Please enter a valid number',
...
const zhCN: Record<LocaleKey, string> = {
	...
	'card.todayTotal': '今日已累计：{{total}}',
	'card.entryCount': '{{count}} 次打卡',
	'modal.customValueTitle': '输入数值',
	'modal.customValuePlaceholder': '完成了多少？',
	'modal.submit': '确认',
	'notice.invalidValue': '请输入有效的数字',
